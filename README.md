...
- LED indicators for work/break modes
...
- 4x4 Keypad
- Buzzer ( Passive )
- Push buttons ( Reset / WakeUp )
- LEDs (green/red)
- 10k/300ohms resistors
- Capacitors ( 100uF Electrolytic / 100nF Ceramic )
- +5v Batteries ( 9v Max )
- ON/OFF Switch
...
- Press # to confirm durations and inputs.
- Press A to start the timer.
- Press B to pause the timer.
